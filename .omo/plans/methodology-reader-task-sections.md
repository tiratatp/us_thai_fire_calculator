...
- [ ] 3. src/methodology/content-read-first.ts: Create Read-first group file with disclaimer + regulatory-uncertainties sections
...
- [ ] 4. src/methodology/content-us-rules.ts: Create US-rules group file with the 9 US sections
...
- [ ] 5. src/methodology/content-thai-rules.ts: Create Thai-rules group file AND merge residency-180-days into thai-residency
...
- [ ] 6. src/methodology/content-interaction.ts: Create Interaction group with treaty sections + ftc-corrected
...
- [ ] 7. src/methodology/content-simulation.ts: Create Simulation group with the remaining algorithm/MC sections and FIRE multipliers
...
- [ ] 8. src/methodology/render.ts + src/methodology/content.ts: Rewire composer to import the 5 new group files and implement nested TOC + H2 groups + H3 sections
...
- [ ] 9. src/methodology/render.test.ts: Update tests to drop residency-180-days and add group/H3/uniqueness assertions
