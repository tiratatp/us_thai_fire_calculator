/**
 * Regulatory Uncertainties — consolidated summary of the four unsettled
 * questions the calculator models under both an optimistic and a
 * pessimistic reading.
 *
 * Sources: .research/03-us-thai-treaty.md, .research/02-thai-tax.md.
 */

import type { MethodologySection } from './content.js';

export const UNCERTAINTIES_SECTIONS: readonly MethodologySection[] = [
  {
