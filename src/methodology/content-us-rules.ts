...
export const US_RULES_GROUP: MethodologyGroup = {
  id: 'group-us-rules',
  title: 'US tax rules that apply to you',
  intro: 'US federal tax rules for citizens abroad, covering ordinary income, capital gains, and retirement account distributions.',
  sections: [
    {
      id: 'us-brackets-2026',
